...
namespace Examen1_LeonardoMadrigal.Models
{
    public class ProyectoLibreriaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Yo tengo muchos usuarios con un rol que se identifica por el UsuarioId
            modelBuilder.Entity<Usuario>().HasOne(u => u.Rol).WithMany(r => r.Usuarios).HasForeignKey(u => u.RolId);
            // Yo tengo muchos usuarios con un estado que se identifica por el UsuarioId
            ...
            //modelBuilder.Entity<Multa>().HasKey(m => m.Id);
